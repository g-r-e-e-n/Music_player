...
@app.on_message(
    filters.command(["mute"], config.PREFIXES) & ~filters.private & ~filters.edited
)
@register
@language
@only_admins
...
@app.on_message(
    filters.command(["unmute"], config.PREFIXES)
    & ~filters.private
    & ~filters.edited
)
@register
...
@app.on_message(
    filters.command(["pause"], config.PREFIXES)
    & ~filters.private
    & ~filters.edited
)
@register
...
@app.on_message(
    filters.command(["resume"], config.PREFIXES)
    & ~filters.private
    & ~filters.edited
)
@register
...
@app.on_message(
    filters.command(["export"], config.PREFIXES)
    & ~filters.private
    & ~filters.edited
)
@register
...
@app.on_message(
    filters.command(["import"], config.PREFIXES)
    & ~filters.private
    & ~filters.edited
)
@register
...
@app.on_message(
    filters.command(["plst", "playlist"], config.PREFIXES)
    & ~filters.private
    & ~filters.edited
)
@register
